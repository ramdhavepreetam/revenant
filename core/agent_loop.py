...
from local_llm_writer import ChatConfig, call_model_message, LocalLLMError, estimate_tokens
from agent_tools import ToolRegistry, ToolError
...
class AgentLoop:
    ...
    def run(self, goal: str) -> AgentResult:
        ...
        if use_native is None:
            from agent_native_tools import supports_native_tools
            try:
