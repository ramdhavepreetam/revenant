...
# Static assets and runtime data are anchored to the CURRENT WORKING DIRECTORY
# (the repo root, where the app is launched from), not the package location.
ROOT = Path.cwd()
...
class AppState:
    ...
    def _prewarm_voice(self) -> None:
        ...
        def _warm() -> None:
            try:
                from aibot_app.aibot_tts import prewarm_voice
                prewarm_voice()
